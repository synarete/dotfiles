 ...
 *
 * pycrc.py --model=crc-32c --algorithm table-driven  --generate c --std=C99
 *
 */
...
void blgn_crc32c(const void *dat, size_t len, uint32_t *res)
{
	*res = crc32c((const uint8_t *)dat, (int)len);
}
