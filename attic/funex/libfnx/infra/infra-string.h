 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 */
#ifndef FNX_INFRA_STRING_H_
#define FNX_INFRA_STRING_H_


typedef int (*fnx_chr_pred)(char);
typedef void (*fnx_chr_modify_fn)(char *);
 ...
 */
const char *fnx_str_find_first_not_eq(const char *s, size_t n, char c);

/*
 * Returns the last occurrence of any of the characters of s2 within the first
 * n1 characters of s1.
 */
const char *fnx_str_find_last_of(const char *s1, size_t n1,
                                 const char *s2, size_t n2);
 ...
 */
const char *
fnx_str_find_last_not_eq(const char *s, size_t n, char c);

/*
 * Returns the number of matching equal characters from the first n characters
 * of s1 and s2.
 */
size_t fnx_str_common_prefix(const char *s1, const char *s2, size_t n);

/*
 * Returns the number of matching equal characters from the last n characters
 * of s1 and s2.
 */
size_t fnx_str_common_suffix(const char *s1, const char *s2, size_t n);
 ...
 * to sz).
 */
size_t fnx_str_insert_chr(char *p, size_t sz,
