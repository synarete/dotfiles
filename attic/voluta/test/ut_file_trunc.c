...
{
	ut_file_trunc_void_(ut_ctx, 0, VOLUTA_KILO);
	ut_file_trunc_void_(ut_ctx, 1, VOLUTA_KILO);
	ut_file_trunc_void_(ut_ctx, 0, VOLUTA_MEGA);
	ut_file_trunc_void_(ut_ctx, 1, VOLUTA_MEGA - 11);
	ut_file_trunc_void_(ut_ctx, VOLUTA_SMEGA, VOLUTA_KILO);
	ut_file_trunc_void_(ut_ctx, VOLUTA_SMEGA - 11, VOLUTA_KILO + 1);
	ut_file_trunc_void_(ut_ctx, VOLUTA_SGIGA - 11, VOLUTA_MEGA + 111);
}

/*. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .*/

static void ut_file_trunc_zero_size_(struct voluta_ut_ctx *ut_ctx, loff_t off)
{
	ino_t ino, dino, root_ino = VOLUTA_INO_ROOT;
	const char *dname = UT_NAME;
	const char *fname = UT_NAME;
...
{
	ut_file_trunc_zero_size_(ut_ctx, 1);
	ut_file_trunc_zero_size_(ut_ctx, VOLUTA_SKILO);
	ut_file_trunc_zero_size_(ut_ctx, VOLUTA_SMEGA);
	ut_file_trunc_zero_size_(ut_ctx, VOLUTA_SMEGA - 1);
	ut_file_trunc_zero_size_(ut_ctx, 11 * VOLUTA_SMEGA + 11);
	ut_file_trunc_zero_size_(ut_ctx, 111 * VOLUTA_SGIGA - 111);
	ut_file_trunc_zero_size_(ut_ctx, VOLUTA_STERA);
	ut_file_trunc_zero_size_(ut_ctx, VOLUTA_STERA + 1111111);
}
