...
extern const struct voluta_ut_tests voluta_ut_utest_alloc;
extern const struct voluta_ut_tests voluta_ut_utest_super;
extern const struct voluta_ut_tests voluta_ut_utest_dir;
extern const struct voluta_ut_tests voluta_ut_utest_dir_iter;
extern const struct voluta_ut_tests voluta_ut_utest_dir_list;
extern const struct voluta_ut_tests voluta_ut_utest_namei;
extern const struct voluta_ut_tests voluta_ut_utest_rename;
extern const struct voluta_ut_tests voluta_ut_utest_symlink;
extern const struct voluta_ut_tests voluta_ut_utest_xattr;
extern const struct voluta_ut_tests voluta_ut_file_basic_tests;
extern const struct voluta_ut_tests voluta_ut_utest_file_ranges;
extern const struct voluta_ut_tests voluta_ut_utest_file_truncate;
extern const struct voluta_ut_tests voluta_ut_utest_file_records;
extern const struct voluta_ut_tests voluta_ut_utest_file_random;
extern const struct voluta_ut_tests voluta_ut_utest_file_fallocate;
extern const struct voluta_ut_tests voluta_ut_utest_file_edges;
