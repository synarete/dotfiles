...
static const struct voluta_t_tdef t_local_tests[] = {
	VOLUTA_T_DEFTESTF(test_copy_file_range_simple1, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_copy_file_range_simple2, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_copy_file_range_simple3, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_copy_file_range_nosrcdata1, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_copy_file_range_nosrcdata2, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_copy_file_range_nodstdata1, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_copy_file_range_nodstdata2, VOLUTA_T_IGNORE),
};

const struct voluta_t_tests voluta_t_test_copy_file_range =
