...
{
	test_clone_file_range_(t_ctx, BK_SIZE);
	test_clone_file_range_(t_ctx, 8 * BK_SIZE);
}

static void test_clone_file_range_large(struct voluta_t_ctx *t_ctx)
{
	test_clone_file_range_(t_ctx, UMEGA);
	test_clone_file_range_(t_ctx, 8 * UMEGA);
}

/*. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .*/

static const struct voluta_t_tdef t_local_tests[] = {
	VOLUTA_T_DEFTESTF(test_clone_file_range_small, VOLUTA_T_IGNORE),
	VOLUTA_T_DEFTESTF(test_clone_file_range_large, VOLUTA_T_IGNORE),
};
