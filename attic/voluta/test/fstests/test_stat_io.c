...
static const struct voluta_t_ioargs s_aligned_ioargs[] = {
	...
	{ 0, VOLUTA_BK_SIZE, 0 },
	{ 0, VOLUTA_MEGA, 0 },
	{ VOLUTA_BK_SIZE, VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_BK_SIZE, 2 * VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_BK_SIZE, VOLUTA_MEGA, 0 },
	{ VOLUTA_MEGA - VOLUTA_BK_SIZE, VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_MEGA, VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_MEGA - VOLUTA_BK_SIZE, 2 * VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_GIGA, VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_GIGA - VOLUTA_BK_SIZE, 2 * VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_GIGA + VOLUTA_BK_SIZE, VOLUTA_BK_SIZE, 0 },
};

static const struct voluta_t_ioargs s_unaligned_ioargs[] = {
	{ 1, 2, 0 },
	{ 1, VOLUTA_BK_SIZE - 2, 0 },
	{ 1, VOLUTA_BK_SIZE + 2, 0 },
	{ 1, VOLUTA_MEGA - 2, 0 },
	{ 1, VOLUTA_MEGA + 2, 0 },
	{ VOLUTA_BK_SIZE - 1, VOLUTA_BK_SIZE + 2, 0 },
	{ VOLUTA_MEGA - VOLUTA_BK_SIZE + 1, 2 * VOLUTA_BK_SIZE + 1, 0 },
	{ VOLUTA_MEGA - 1, VOLUTA_BK_SIZE + 11, 0 },
	{ VOLUTA_MEGA - VOLUTA_BK_SIZE - 1, 11 * VOLUTA_BK_SIZE, 0 },
	{ VOLUTA_GIGA - 1, VOLUTA_BK_SIZE + 2, 0 },
	{ VOLUTA_GIGA - VOLUTA_BK_SIZE - 1, 2 * VOLUTA_BK_SIZE + 2, 0 },
	{ VOLUTA_GIGA + VOLUTA_BK_SIZE + 1, VOLUTA_BK_SIZE - 1, 0 },
};
...
{
	for (size_t i = 0; i < VOLUTA_ARRAY_SIZE(s_aligned_ioargs); ++i) {
...
{
	for (size_t i = 0; i < VOLUTA_ARRAY_SIZE(s_unaligned_ioargs); ++i) {
...
static void test_stat_punch_(struct voluta_t_ctx *t_ctx,
			     const struct voluta_t_ioargs *ioargs)
{
	int fd, mode, o_flags = O_CREAT | O_RDWR;
	size_t nwr;
	blkcnt_t blkcnt;
	struct stat st;
	void *buf;
