 ...
 */
static void test_unlink_reg(struct vt_env *vt_env)
{
	int fd;
	struct stat st;
...
static void test_unlink_symlink(struct vt_env *vt_env)
{
	int fd;
	struct stat st;
...
static void test_unlink_fifo(struct vt_env *vt_env)
{
	struct stat st;
	const char *path = vt_new_path_unique(vt_env);
 ...
 * is not a directory.
 */
static void test_unlink_notdir(struct vt_env *vt_env)
{
	int fd;
	struct stat st;
	const char *path0 = vt_new_path_unique(vt_env);
 ...
 */
static void test_unlink_isdir(struct vt_env *vt_env)
{
	struct stat st;
	const char *path = vt_new_path_unique(vt_env);
 ...
 */
static void test_unlinkat_same_name(struct vt_env *vt_env)
{
	size_t nfds = 0;
	int dfd, fd, fds[64];
	struct stat st;
